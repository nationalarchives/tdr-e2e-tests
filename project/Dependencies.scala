...
object Dependencies {
  ...
  private val cucumberCoreVersion = "7.3.2"
  private val cucumberScalaVersion = "8.3.1"
  private val cucumberJUnitVersion = "7.3.2"
  ...
  lazy val tdrGraphQlClient    = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.29"
  lazy val tdrGenerateGraphQl  = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.236"

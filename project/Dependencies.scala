...
object Dependencies {
  ...
  private val cucumberCoreVersion = "7.15.0"
  private val cucumberScalaVersion = "8.20.0"
  private val cucumberJUnitVersion = "7.15.0"
  private val keycloakVersion = "23.0.5"
  private val softwareMillVersion = "2.3.0"

  lazy val tdrGraphQlClient    = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.144"
  ...
  lazy val tdrGenerateGraphQl  = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.358"

...
object Dependencies {
  ...
  private val cucumberCoreVersion = "7.3.0"
  private val cucumberScalaVersion = "8.2.8"
  private val cucumberJUnitVersion = "7.3.0"
  ...
  lazy val tdrGenerateGraphQl  = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.235"

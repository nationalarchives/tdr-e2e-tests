...
object Dependencies {
  ...
  private val cucumberCoreVersion = "7.19.0"
  private val cucumberScalaVersion = "8.23.1"
  private val cucumberJUnitVersion = "7.19.0"
  ...
  lazy val tdrGenerateGraphQl  = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.388"

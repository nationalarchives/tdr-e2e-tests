...
object Dependencies {
  ...
  private val cucumberScalaVersion = "8.12.0"
  private val cucumberJUnitVersion = "7.10.0"
  private val keycloakVersion = "20.0.1"
  private val softwareMillVersion = "2.3.0"

  lazy val tdrGraphQlClient    = "uk.gov.nationalarchives" %% "tdr-graphql-client" % "0.0.74"
  ...
  lazy val tdrGenerateGraphQl  = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.287"
